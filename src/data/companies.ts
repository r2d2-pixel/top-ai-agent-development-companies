...
export const companies: Company[] = [
  {
    ...
    tagline: "AI agent development company with senior-only delivery, built on 25 years of software delivery history.",
    description:
    ...
    primaryDifferentiator: "A senior-only delivery model — every engagement is staffed by engineers who work agent systems full-time, with no junior bench standing in the gap.",
